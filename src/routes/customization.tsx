  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: heroImg },
        ...
        links: [{ rel: "canonical", href: "https://thegifting-lab.com/customization" }],
        scripts: [
          {
                    ...
                    children: JSON.stringify({
                                ...
                                itemListElement: [
                                  ...
                                  { "@type": "ListItem", position: 2, name: "Customization", item: "https://thegifting-lab.com/customization" },
                                            ],
                    }),
          },
              ],
