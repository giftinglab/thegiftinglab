...
const PAGE_URL = "https://thegifting-lab.com/corporate-gifts-malaysia";
const PAGE_TITLE = "Corporate Gifts Malaysia | Onboarding Kits & Branded Merch | KL — The Gifting Lab";
const PAGE_DESC = "Corporate gifting studio based in Kuala Lumpur. Custom onboarding kits, festive hampers and eco gifts for Malaysian businesses, delivered nationwide in 15–30 days.";

export const Route = createFileRoute("/corporate-gifts-malaysia")({
  head: () => ({
    meta: [
      { title: PAGE_TITLE },
      { name: "description", content: PAGE_DESC },
      { name: "keywords", content: "Corporate Gifts Malaysia, Corporate Gifts Kuala Lumpur, Custom Corporate Gifts Malaysia, Corporate Gift Supplier Malaysia, CNY Hampers Malaysia, Raya Hampers Malaysia" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Corporate Gifts Malaysia", item: PAGE_URL },
          ],
        }),
      },
      {
  ...
  component: CorporateGiftsMalaysia,
});
...
const audiences = [
  ...
  { icon: Award, t: "Startups, SMEs & MNCs", d: "From 50 units to 10,000+ — scalable gifting for every stage of growth in Malaysia." },
];
...
const categories = [
  ...
  { title: "Event & Conference Gifts", img: ucEvent, desc: "Speaker gifts, delegate kits and roadshow giveaways for Malaysian events and trade shows." },
  { title: "CNY & Raya Hampers", img: ucFestive, desc: "Chinese New Year, Hari Raya and Christmas hampers curated for clients, partners and employees." },
...
const whyUs = [
  { i: Globe2, t: "Kuala Lumpur-based team", d: "Local sourcing, local team, no import markup on domestic Malaysian orders." },
  ...
  { i: Award, t: "Direct factory relationships", d: "No middlemen — better pricing at scale across our Malaysia, China and Vietnam supply chain." },
];
...
const process = [
  ...
  { n: "04", t: "Deliver nationwide", d: "Bulk delivery to your office, event venue, or individual addresses across Malaysia." },
];

const faqs = [
  {
    q: "How far in advance should we order CNY or Raya hampers?",
    a: "We recommend briefing 8–10 weeks before the festive period to allow for sampling and production capacity, which gets tight closer to the date.",
  },
  {
    q: "Do you handle bespoke product design, not just branding?",
    a: "Yes — from sketch to sample, MOQ from 300 units for fully bespoke product designs. Curated kits start from 25–50 units.",
  },
  {
    q: "What areas in Malaysia do you deliver to?",
    a: "Nationwide, with same-region delivery fastest from our Kuala Lumpur hub. We also regularly combine Malaysia and Singapore offices in a single project.",
  },
  {
    q: "How long does it take to produce and deliver custom corporate gifts?",
    a: "Standard lead time is 15–30 days from artwork approval, including production, branding, QC, kitting and delivery. Rush orders can sometimes be accommodated — share your deadline with us and we'll advise honestly.",
  },
  {
    q: "Do you offer eco-friendly and sustainable corporate gifts?",
    a: "Yes. We have a full range of eco-friendly corporate gifts including recycled materials, FSC-certified paper, biodegradable packaging and ethically-sourced products.",
  },
  {
...
function CorporateGiftsMalaysia() {
  return (
    <SiteLayout>
      {/* HERO */}
        ...
        <div className="container-page pt-16 pb-20 md:pt-24 md:pb-28 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-7 animate-fade-up">
            <span className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-gold bg-secondary/50 px-3 py-1 rounded-full">
              <span className="h-1.5 w-1.5 rounded-full bg-gold" /> Kuala Lumpur · B2B Corporate Gifting
            </span>
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.02]">
              Corporate gifts,<br />
              <span className="italic text-muted-foreground">designed and produced</span><br />
              in Kuala Lumpur.
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl">
              The Gifting Lab is a Kuala Lumpur-based corporate gifting studio building custom onboarding kits, VIP gifts, festive hampers and event giveaways for Malaysian businesses since 2019.
            </p>
            <ul className="grid sm:grid-cols-2 gap-y-2 gap-x-6 text-sm">
              {["Custom branding & packaging", "Nationwide MY delivery", "Low MOQ from 25 units", "Quote within 48 hours"].map((f) => (
          ...
          <div className="lg:col-span-6 relative animate-fade-in">
            ...
            <img
              src={heroImg}
              alt="Premium corporate gift kit Malaysia — branded navy box with tote, mug, notebook and brass pen"
              width={1920}
              height={1080}
            ...
            <div className="absolute -bottom-6 -left-6 hidden md:flex flex-col gap-1 rounded-2xl bg-background border border-border p-5 shadow-xl">
              <span className="text-xs text-muted-foreground">MY delivery</span>
      ...
      <section className="container-page py-20 md:py-28 max-w-4xl">
        <span className="text-xs tracking-widest uppercase text-gold">Malaysia's corporate gifting studio</span>
        ...
        <div className="mt-8 space-y-5 text-lg text-muted-foreground leading-relaxed">
          <p>
            The Gifting Lab is a Kuala Lumpur-based corporate gifting studio building custom onboarding kits, VIP gifts, festive hampers and event giveaways for Malaysian businesses since 2019 — with direct factory relationships across Malaysia, China and Vietnam, and RM pricing from MOQ 25 units.
          </p>
          <p>
            We work with HR, marketing and procurement teams at startups, SMEs and MNCs to design, produce and deliver fully customized corporate gifts across Malaysia, with the quality control and consistency that B2B buyers expect — including deep experience with CNY and Raya festive gifting cycles and timelines.
          </p>
          <p>
            Whether you need 50 onboarding kits for a growing tech team, 800 VIP hampers for year-end client gifting, or a nationwide rollout timed to Chinese New Year, we handle the end-to-end process — sourcing, custom branding, packaging, kitting, QC and nationwide delivery.
          </p>
        </div>
      </section>
      ...
      <section className="bg-secondary/30 border-y border-border">
        <div className="container-page py-20 md:py-24">
          <SectionHeader
            ...
            title="Built for Malaysia's most demanding teams."
      ...
      <section className="container-page py-24 md:py-28">
        <SectionHeader
          ...
          title="A full range of corporate gifts for Malaysian businesses."
          ...
          {categories.map((c) => (
            <article key={c.title} className="group rounded-2xl overflow-hidden bg-card border border-border hover:border-foreground/30 transition-colors">
              <div className="overflow-hidden aspect-[4/3]">
                <img src={c.img} alt={`${c.title} Malaysia`} loading="lazy" width={1024} height={768} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
        ...
        <div className="container-page py-24 md:py-28">
          <div className="flex items-end justify-between gap-6 mb-12">
            <SectionHeader
              ...
              title="Best-selling corporate gift kits in Malaysia."
            ...
            {products.map((p) => (
              <div key={p.name} className="group">
                <div className="overflow-hidden rounded-2xl bg-background aspect-square border border-border">
                  <img src={p.img} alt={`${p.name} — corporate gift Malaysia`} loading="lazy" width={1024} height={1024} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
        ...
        <div className="container-page py-24 md:py-28 grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="font-display text-4xl md:text-5xl leading-[1.05]">
              The corporate gift supplier Malaysian teams actually recommend.
            </h2>
        ...
        <div className="container-page py-20">
          ...
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              { to: "/case-studies", t: "Case Studies", d: "Real programs we've delivered for MY & SG teams." },
            ].map((l) => (
      ...
      <section className="container-page py-24 md:py-28 max-w-3xl">
        <SectionHeader
          eyebrow="FAQ"
          title="Corporate gifts in Malaysia — answered."
      ...
      <section className="container-page pb-24">
        <div className="rounded-3xl bg-secondary p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative space-y-6 max-w-2xl mx-auto">
            <h2 className="font-display text-4xl md:text-5xl leading-[1.05]">
              Ready to plan your next corporate gift program in Malaysia?
            </h2>
