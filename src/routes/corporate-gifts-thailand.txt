...
const PAGE_URL = "https://thegifting-lab.com/corporate-gifts-thailand";
const PAGE_TITLE = "Corporate Gifts Thailand | Bangkok Fulfillment | The Gifting Lab";
const PAGE_DESC = "Custom corporate gift kits fulfilled from our Bangkok hub - onboarding, event and festive gifts for Thai businesses, priced in THB, delivered in 15-30 days.";

export const Route = createFileRoute("/corporate-gifts-thailand")({
  head: () => ({
    meta: [
      { title: PAGE_TITLE },
      { name: "description", content: PAGE_DESC },
      { name: "keywords", content: "Corporate Gifts Thailand, Corporate Gifts Bangkok, Custom Corporate Gifts Thailand, Corporate Gift Supplier Thailand, Event Gifts Bangkok" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Corporate Gifts Thailand", item: PAGE_URL },
          ],
        }),
      },
      {
  ...
  component: CorporateGiftsThailand,
});
...
const audiences = [
  ...
  { icon: Award, t: "Startups, SMEs & MNCs", d: "From 50 units to 10,000+ - scalable gifting for every stage of growth in Thailand." },
];
...
const categories = [
  ...
  { title: "Event & Conference Gifts", img: ucEvent, desc: "Speaker gifts, delegate kits and roadshow giveaways for Bangkok events and trade shows." },
  { title: "Festive Corporate Hampers", img: ucFestive, desc: "New Year and year-end hampers curated for clients, partners and employees." },
...
const whyUs = [
  { i: Globe2, t: "Bangkok fulfillment hub", d: "No cross-border shipping delay for Thailand deliveries - fulfilled locally from Bangkok." },
  ...
  { i: Truck, t: "Fast turnaround", d: "Most corporate gift programs ship within 15-30 days, including custom branding, plus local last-mile delivery." },
  ...
  { i: Award, t: "Regional supply chain", d: "Same design and sourcing team behind our Singapore and Malaysia programs, with THB pricing." },
];
...
const process = [
  ...
  { n: "04", t: "Deliver from Bangkok", d: "Local last-mile delivery to your office, event venue, or individual addresses in Thailand." },
];

const faqs = [
  {
    q: "Do you have local fulfillment in Thailand, or does everything ship from Malaysia?",
    a: "We fulfill from our Bangkok hub, so Thailand deliveries don't carry the cross-border lead time of MY/SG-only suppliers.",
  },
  {
    q: "Can pricing and invoicing be in THB?",
    a: "Yes - THB pricing and invoicing is available for Thailand-based orders.",
  },
  {
    q: "What's the typical lead time for Thailand delivery?",
    a: "In line with our standard 15-30 day production window, plus local last-mile delivery from Bangkok.",
  },
  {
    q: "What's the minimum order quantity for corporate gifts in Thailand?",
    a: "Most customized corporate gift programs start from 25-50 units for curated kits. For fully bespoke gifts with custom packaging, MOQs typically begin at 300 units.",
  },
  {
...
function CorporateGiftsThailand() {
  return (
    <SiteLayout>
      {/* HERO */}
        ...
        <div className="container-page pt-16 pb-20 md:pt-24 md:pb-28 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-7 animate-fade-up">
            <span className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-gold bg-secondary/50 px-3 py-1 rounded-full">
              <span className="h-1.5 w-1.5 rounded-full bg-gold" /> Bangkok - B2B Corporate Gifting
            </span>
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.02]">
              Corporate gifts,<br />
              <span className="italic text-muted-foreground">fulfilled from</span><br />
              our Bangkok hub.
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl">
              The Gifting Lab fulfills custom corporate gift kits - onboarding boxes, event giveaways, festive hampers and VIP gifts - for businesses in Thailand, with THB pricing and the same regional design team behind our Singapore and Malaysia programs.
            </p>
            <ul className="grid sm:grid-cols-2 gap-y-2 gap-x-6 text-sm">
              {["Custom branding & packaging", "Bangkok-based fulfillment", "Low MOQ from 25 units", "Quote within 48 hours"].map((f) => (
          ...
          <div className="lg:col-span-6 relative animate-fade-in">
            ...
            <img
              src={heroImg}
              alt="Premium corporate gift kit Thailand - branded navy box with tote, mug, notebook and brass pen"
              width={1920}
              height={1080}
            ...
            <div className="absolute -bottom-6 -left-6 hidden md:flex flex-col gap-1 rounded-2xl bg-background border border-border p-5 shadow-xl">
              <span className="text-xs text-muted-foreground">TH delivery</span>
      ...
      <section className="container-page py-20 md:py-28 max-w-4xl">
        <span className="text-xs tracking-widest uppercase text-gold">Thailand's regional gifting partner</span>
        ...
        <div className="mt-8 space-y-5 text-lg text-muted-foreground leading-relaxed">
          <p>
            The Gifting Lab fulfills custom corporate gift kits - onboarding boxes, event giveaways, festive hampers and VIP gifts - for businesses in Thailand from our Bangkok fulfillment hub, with THB pricing and the same regional design and sourcing team behind our Singapore and Malaysia programs.
          </p>
          <p>
            We work with HR, marketing and procurement teams at startups, SMEs and MNCs to design, produce and deliver fully customized corporate gifts across Thailand, with the quality control and consistency that B2B buyers expect - and without the cross-border shipping delay of suppliers fulfilling only from Malaysia or Singapore.
          </p>
          <p>
            Whether you need 50 onboarding kits for a growing Bangkok office, VIP hampers for year-end client gifting, or delegate kits for a regional conference, we handle the end-to-end process - sourcing, custom branding, packaging, kitting, QC and local delivery.
          </p>
        </div>
      </section>
      ...
      <section className="bg-secondary/30 border-y border-border">
        <div className="container-page py-20 md:py-24">
          <SectionHeader
            ...
            title="Built for Thailand's most demanding teams."
      ...
      <section className="container-page py-24 md:py-28">
        <SectionHeader
          ...
          title="A full range of corporate gifts for Thai businesses."
          ...
          {categories.map((c) => (
            <article key={c.title} className="group rounded-2xl overflow-hidden bg-card border border-border hover:border-foreground/30 transition-colors">
              <div className="overflow-hidden aspect-[4/3]">
                <img src={c.img} alt={`${c.title} Thailand`} loading="lazy" width={1024} height={768} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
        ...
        <div className="container-page py-24 md:py-28">
          <div className="flex items-end justify-between gap-6 mb-12">
            <SectionHeader
              ...
              title="Best-selling corporate gift kits in Thailand."
            ...
            {products.map((p) => (
              <div key={p.name} className="group">
                <div className="overflow-hidden rounded-2xl bg-background aspect-square border border-border">
                  <img src={p.img} alt={`${p.name} - corporate gift Thailand`} loading="lazy" width={1024} height={1024} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
        ...
        <div className="container-page py-24 md:py-28 grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="font-display text-4xl md:text-5xl leading-[1.05]">
              The corporate gift supplier Thai teams actually recommend.
            </h2>
      ...
      <section className="container-page py-24 md:py-28 max-w-3xl">
        <SectionHeader
          eyebrow="FAQ"
          title="Corporate gifts in Thailand - answered."
      ...
      <section className="container-page pb-24">
        <div className="rounded-3xl bg-secondary p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative space-y-6 max-w-2xl mx-auto">
            <h2 className="font-display text-4xl md:text-5xl leading-[1.05]">
              Ready to plan your next corporate gift program in Thailand?
            </h2>
